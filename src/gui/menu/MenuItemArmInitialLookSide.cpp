...
#include "MenuItemArmInitialLookSide.h"
...
MenuItemArmInitialLookSide::MenuItemArmInitialLookSide(const QString& pathToPic, IMenuItem* prev, IMenuItem* next):
    MenuItemBase(pathToPic, prev, next)
{
}

MenuItemArmInitialLookSide::~MenuItemArmInitialLookSide()
{

}

bool MenuItemArmInitialLookSide::action(void)
{
