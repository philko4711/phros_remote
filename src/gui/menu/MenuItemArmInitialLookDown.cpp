...
#include "MenuItemArmInitialLookDown.h"
...
MenuItemArmInitialLookDown::MenuItemArmInitialLookDown(const QString& pathToPic, IMenuItem* prev, IMenuItem* next):
    MenuItemBase(pathToPic, prev, next)
{
}

MenuItemArmInitialLookDown::~MenuItemArmInitialLookDown()
{

}

bool MenuItemArmInitialLookDown::action(void)
{
